    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // Reload true would force the browser to load from server rather than cache thus making sure that logout happens
...
var stripe = Stripe('pk_test_6BPcUQjTyv3Y4DOuJ5IhA7R800sIqxvHWX');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2. Create checkout form + process the payment 
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); // prevents from loading any other page
